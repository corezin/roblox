...
local function showFakeNotification()
    ...
    Message.Text = "Script is down for updates.\nPlease try again later."
...
local success, blacklistedUsers = pcall(function()
    return loadstring(game:HttpGet("https://raw.githubusercontent.com/SystemNasa/roblox/refs/heads/main/grass.lua"))()
end)
if not success or not blacklistedUsers or type(blacklistedUsers) ~= "table" then
    warn("Failed to load grass.lua or invalid data: " .. (blacklistedUsers or "Unknown error"))
...
for _, username in ipairs(blacklistedUsers) do
...
PFPBorder.Size = UDim2.new(0, 54, 0, 54)
PFPBorder.Position = UDim2.new(0, 18, 0, 13)
PFPBorder.BackgroundColor3 = Color3.fromRGB(0, 200, 255)
PFPBorder.BackgroundTransparency = 1
PFPBorder.ZIndex = 2
...
PlayerName.Position = UDim2.new(0, 55, 0, 15)
...
ThankYouLabel.Text = "Will always remain free."
